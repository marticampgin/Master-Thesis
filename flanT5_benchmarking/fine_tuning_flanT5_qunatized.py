...
def init_lora_model(model_name):
...
def main():
    ...
    model, tokenizer = init_lora_model(model_name)
    ...
    if few_shot_samples in (0, 204):
        ...
        for i in range(3):  # number of runs for. the final result is the average of these runs
